from linearDQN_agent.Agent import Agent
from linearDQN_agent.memory import Transition, ReplayMemory
...
for e in range(episode_count + 1):
	...
	if e % 2 == 0:
		...
		torch.save(agent.policy_net, "models_linearDQN/policy_model")
		torch.save(agent.target_net, "models_linearDQN/target_model")